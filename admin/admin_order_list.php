...
<head>
    ...
    <title>Order List | EATARIA</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <?php
            if(isset($_GET["search"])){
                ...
                $query = "SELECT orh.orh_id,orh.orh_refcode,orh.orh_ordertime,c.c_firstname,c.c_lastname,orh.orh_orderstatus,s.s_name
                FROM order_header orh INNER JOIN customer c ON orh.c_id = c.c_id 
                ...
                $query = "SELECT orh.orh_id,orh.orh_refcode,orh.orh_ordertime,c.c_firstname,c.c_lastname,orh.orh_orderstatus,s.s_name
                FROM order_header orh INNER JOIN customer c ON orh.c_id = c.c_id  INNER JOIN shop s ON orh.s_id = s.s_id ORDER BY orh.orh_ordertime DESC;";
            }
